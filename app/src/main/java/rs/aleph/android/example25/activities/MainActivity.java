    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                ...
                dialog.setTitle(R.string.dialog_title_insert_data);
                ...
                ok.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            categories = getDatabaseHelper().getCategoryDao().queryForAll();
                        } catch (SQLException e) {
                            e.printStackTrace();
                        }
                        ...
                        addItem(editName.getText().toString(), editDescription.getText().toString(), ratingBar.getRating(), (Category)category.getSelectedItem(),(String)image.getSelectedItem());
                        dialog.dismiss();
                    }
                });
